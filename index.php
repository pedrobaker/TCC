		...
		<div class='container'>
			<div class='row'>
				<div class='col s12 m12 l6'>
					...
					<h6><p class='grey-text text-lighten-4'>Agilize seu refeitório. A fome não espera!</p></h6>
				</div>
				<div class='col s12 l4 offset-12'>
					<h5 class='white-text'>Navegue</h5>
					<ul>
						<h6><li><a href="" class='grey-text text-lighten-3'>Home</a></li></h6>
						<h6><li><a href="" class='grey-text text-lighten-3'>Produtos</a></li></h6>
						<h6><li><a href="" class='grey-text text-lighten-3'>Contato</a></li></h6>
					</ul>
				</div>
			</div>
		</div>
